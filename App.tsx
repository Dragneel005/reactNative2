import { SafeAreaView, ScrollView, StyleSheet, Text, TextInput, Touchable, TouchableOpacity, View, Button } from 'react-native'
...
const PasswordSchema = Yup.object().shape({
  passwordLength: Yup.number().min(1, 'Please enter a password length').required('Length is required')
})
